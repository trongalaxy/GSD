...
contract Oracle is IOracle {
    ...
    function setup() public onlyDao {
        _pair = IUniswapV2Pair(IUniswapV2Factory(UNISWAP_FACTORY).createPair(_dollar, husd()));
    ...
    function updateOracle() private returns (Decimal.D256 memory, bool) {
        ...
        bool isBlacklisted = IHUSD(husd()).isBlacklist(address(_pair));
    ...
    function husd() internal view returns (address) {
